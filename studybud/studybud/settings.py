...
SECRET_KEY = 'django-insecure-)#40s#&-i@vcpx)gzt!rg9vxj0)uhzp^^ohuo$kn72_nsczp2b'
...
DATABASES = {
    'default': {
        ...
        'URL':  os.getenv('postgresql://postgres:1*CccDEdB6326F15D-de2BC1e1CaCBd1@monorail.proxy.rlwy.net:16945/railway'),
